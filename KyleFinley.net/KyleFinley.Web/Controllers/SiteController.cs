...
namespace KyleFinley.Web.Controllers {
    public abstract class SiteController : BaseController {
        ...
        public SiteController(ICommandDispatcher dispatcher)
            ...
            base.Site = "kylefinley.net";
            base.TwitterHandle = "kfinley";
        }

        public SiteController(ICommandDispatcher dispatcher, IHttpContext httpContext)
        ...
        public BaseViewData SetProperties(BaseViewData viewData) {
            ...
            try {
                viewData.PageImage = ((viewData as BaseViewData<Entity>).Page as Page).PageImage;
            } catch (Exception) { }
        ...
        protected override void HandleUnknownAction(string actionName) {
            ...
            var viewData = this.CreateViewData<ErrorViewData>();
            viewData.NoIndex = true;
