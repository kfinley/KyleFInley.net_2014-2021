...
namespace KyleFinley.Commands {
    public class CreateCategory : BaseDataSourcedCommand<Category>, ICommand {

        public CreateCategory(IRepository<Category> repository, IHttpContext context)
        ...
        public void Execute() {
            ...
            try {
                ...
                createUrl.Data = new SiteUrl {
                    ...
                    EntityType = (int)EntityType.Category,
                    Path = this.Url
                };
